...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record3<Long, String, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@NotNull Long value1, @NotNull String value2, @NotNull OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public LinkRecord(@NotNull Long id, @NotNull String url, @NotNull OffsetDateTime lastCheck) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(ru.tinkoff.edu.java.scrapper.service.impl.jooq.codegen.public_.tables.pojos.Link value) {
        super(Link.LINK);
